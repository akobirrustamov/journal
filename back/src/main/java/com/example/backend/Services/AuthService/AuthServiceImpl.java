...
public class AuthServiceImpl implements AuthService {
    ...
    public User decode(String token) {
        ...
        User userNotFound = userRepo.findById(UUID.fromString(userId)).orElseThrow(() -> new RuntimeException("User not found"));
    ...
    public User changeRole(String token, Integer roleId) {
        User decode = decode(token);// Ensure token is valid and user exists
