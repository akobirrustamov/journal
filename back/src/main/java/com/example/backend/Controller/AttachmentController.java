...
public class AttachmentController {
    ...
    @PostMapping("/upload")
    public HttpEntity<?> uploadFile(@RequestParam MultipartFile photo,
    ...
    @GetMapping("/img/{id}")
    public void openImage(HttpServletResponse response, @PathVariable UUID id) throws IOException {
