...
export const Student = () => {
  ...
  const createStudent = async (studentData) => {
    try {
      ...
      alert("O'quvchi yaratishda xatolik yuz berdi");
    }
  };
  ...
  const updateStudent = async (id, studentData) => {
    try {
      ...
      alert("O'quvchini yangilashda xatolik yuz berdi");
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.studentIdNumber || formData.studentIdNumber.length !== 14 || !/^\d{14}$/.test(formData.studentIdNumber)) {
      alert("O'quvchi ID raqami aniq 14 ta raqamdan iborat bo'lishi kerak!");
      return;
    }
    ...
    if (!formData.phone || formData.phone.length !== 13 || !/^\+998\d{9}$/.test(formData.phone)) {
      alert("Telefon raqami +998 bilan boshlanishi va aniq 13 ta belgidan iborat bo'lishi kerak!");
      return;
    }
            ...
            <div className="space-y-4">
              ...
              <div className="mt-6 rounded-lg bg-gradient-to-r from-blue-50 to-cyan-50 p-4 border border-blue-200">
                ...
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 text-sm">
                  <div>
                    <span className="text-gray-600">Jami yuklandi:</span>
